...
#set document(title: [Group 11 - Technical Report - IBM VR Game], author: ("Alexandre Pinheiro Dias", "Jing Lei Wong", "Rohab Kashif", "Siang Wei Law", "Muhammad Rafay Abbas"))
...
#table(
  ...
  [BR1.1], [Look around with VR headset], [Unchanged], [Fully Met], [Implemented using WebXR API in Godot; headset movement accurately rotates the viewport.],
  ...
  [BR1.4], [Teleport via VR controller trigger], [Deemed unnecessary since the rooms are too small], [Not Met], [Teleportation is not implemented since the rooms are too small hence it is unnecessary, and likely would be more of a hinderance and source of bugs.],
  ...
  [BR2.3], [Teleport with right-click], [Deemed unnecessary since the rooms are too small], [Not Met], [Teleportation is not implemented since the rooms are too small hence it is unnecessary, and likely would be more of a hinderance and source of bugs.],
  [BR3.1], [VR prompt with headset], [Unchanged], [Fully Met], [Browser prompt to enter VR is shown after selecting a course.],
  [BR3.2], [Prompt to play 3D without headset], [Unchanged], [Not Met], [Non-VR users will *not* receive a suggestion prompt to play in 3D.],
  [BR3.3], [WASM support check], [Non-priority, WASM is enabled by default in all modern browsers.], [Partially Met], [Detects WASM support, message is only logged to browser console.],
  [BR4.1], [Auto-save progress], [Non-priority, sessions do not take long.], [Not Met], [Progress will be reset after restarting the game (leaderboard and settings are saved).],
  ...
  [BR4.5], [Resume from save], [Unchanged], [Not Met], [Game saves are not implemented, so this isn't aswell],
  [BR5.1], [Session completes in 15 min], [Modified: Adjusted to 10-20 min], [Fully Met], [Sessions are be timed to fit within 20 minutes (1min per question).],
  [BR5.2], [Notify session length], [Unchanged], [Not Met], [Game does not display estimated completion time (pending).],
  [BR5.3], [Continue after session], [Unchanged], [Fully Met], [Returns to main menu after completion, where users can play again],
  [BR6.1], [Select and enter course], [Unchanged], [Fully Met], [Course selection shows available SkillsBuild courses and enters upon clicking.],
  [BR6.2], [Return to course menu], [Unchanged], [Fully Met], [Accessible from pause and from the main menu.],
  [BR6.3], [Show course details], [Unchanged], [Not Met], [Descriptions of courses are not shown (pending).],
  [BR6.4], [Recommend related courses], [Won't be implemented], [Not Met], [Feature planned but will not implemented since there are only a limited amount courses.],
  [BR7.1], [Review incorrect answers], [Unchanged], [Fully Met], [Post-session review shows questions with their given and correct answers.],
  [BR7.2], [Compare performance trends], [Unchanged], [Partially Met], [Basic performance trends through graphs are not presented, alternatively leaderboard is provided.],
  [BR7.3], [Review time per question], [Unchanged], [Not Met], [Time taken per question is recorded but not analysed or displayed.],
  [BR8.1], [Points for correct answers], [Modified score factors: correctness, time taken, question difficulty], [Fully Met], [Scoring system awards points accurately based on time taken, question difficulty and percentage of answer correctness (for multiple choice)],
  [BR8.2], [No points for incorrect], [Unchanged], [Fully Met], [Incorrect answers do not increment score.],
  [BR8.3], [Bonus for fast completion], [Modified: time factor now included in question score], [Fully Met], [Completing individual questions fast awards more points.],
  [BR9.1], [Display high score], [Unchanged], [Fully Met], [Leaderboard is provided and sorted by score, and displays score, time taken and session name.],
  [BR9.2], [View high score list], [Unchanged], [Fully Met], [Leaderboard accessible from main menu.],
  [BR9.3], [Handle tied scores], [Unchanged], [Fully Met], [Score now includes time factor, therefore equal scores are marked the same],
  [BR10.1 and BR10.2], [Question difficulty changes based on user performance], [Unchanged], [Fully Met], [
  ...
  [BR11.1], [Visual accessibility options], [Unchanged], [Not Met], [Colourblind mode and text scaling not implemented yet.],
  [BR11.2], [Auditory accessibility options], [Audio cues and subtitles are not needed since there are only sound effects.], [Fully Met], [Volume controls are implemented, other auditory accessibility options weren't added since current sounds are only interaction sounds which have corresponding visual cues.],
  [BR11.3], [Motor accessibility options], [Unchanged], [Not Met], [Basic control remapping and sensitivity adjustments pending.],
  [BR12.1], [Set up local multiplayer], [Unchanged], [Not Met], [Optional feature not implemented due to focus on core gameplay.]
)
...
#figure(image("systemarchitecture.png"), caption: "first draft")
...
#figure(image("game_flow_diagram.svg"), caption: "final architecture") <game_flow>
...
== Launching: Provide instructions on creating a user account or logging into the system. Guide users through any first-time setup steps, such as creating admin accounts or configuring user settings. // 5%
  ...
  See #ref(<usage_instructions>) for more information on how to play.
